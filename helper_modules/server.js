    ...
    MongoClient.connect(url,function(err,db){ 
        if(err){
            console.log("Unable to connect to the mongoDb server",err);
                ...
                res.render("product-details.ejs",{quantity:count,chocolatename:chocolatename,email:req.session.key["name"],image:image_location,price:price,id:id});
                });
...
app.get('/cart.html',function(req,res){
    ...
    price = parseFloat(productresult["price"])*parseInt(productresult["quantity"]); 
    res.render("cart.ejs",{email:req.session.key["name"],image : productresult["image"],productname:productresult["name"], id:productresult["id"],price:price,quantity:productresult["quantity"]});
});
